...
`_linux` triples are pending the `regenerate-linux-goldens` workflow dispatch
on this branch. All 10 goldens × 2 variants = 20 fixture triples (18 committed

+ 2 pending linux). The `regenerate-linux-goldens` workflow
